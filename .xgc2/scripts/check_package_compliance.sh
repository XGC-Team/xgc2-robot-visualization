...
grep -q 'ros-noetic-xgc2-gazebo-sim-mecanum (>= 0.1.0-1)' .xgc2/product.yml
...
grep -q '<exec_depend>gazebo_sim_mecanum</exec_depend>' package.xml
...
grep -q '^Depends:.*xgc2-gazebo-sim-mecanum' .xgc2/scripts/package_debs.sh
