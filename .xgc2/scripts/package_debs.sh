...
Depends: ros-${ROS_DISTRO}-geometry-msgs, ros-${ROS_DISTRO}-roscpp, ros-${ROS_DISTRO}-std-msgs, ros-${ROS_DISTRO}-visualization-msgs, ros-${ROS_DISTRO}-xgc2-fs150-description (>= 0.1.0-3) (>= 0.1.0-1), ros-${ROS_DISTRO}-xgc2-scout-description (>= 0.4.10-8)
